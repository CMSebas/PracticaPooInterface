...
public class VentRegProdu extends Frame implements ActionListener {
    ...
    public VentRegProdu(Ventana1 ventanaPrincipal) {
        ...
        labelNumero3 = new Label("Tipo ");
        labelNumero4 = new Label("Proveedor ");
        labelNumero5 = new Label("Cantidad ");
